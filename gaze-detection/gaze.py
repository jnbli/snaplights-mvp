...
def get_gaze_ratio(eye_points, facial_landmarks):
	...
	left_eye = cv2.bitwise_or(gray, gray, mask=mask)
...
while True:
	...
	# for face in faces:
		...
		if gaze_ratio < 0.6:
			...
			if "LEFT" != gaze_direction:
				gaze_direction = "LEFT"
		elif 0.6 <= gaze_ratio and gaze_ratio <= 2.2:
			cv2.putText(frame, "CENTER", (50, 100), font, 2, (0, 0, 255), 3)
			if "CENTER" != gaze_direction:
				gaze_direction = "CENTER"
		elif gaze_ratio > 2.2:
			cv2.putText(frame, "RIGHT", (50, 100), font, 2, (0, 0, 255), 3)
			if "RIGHT" != gaze_direction:
				gaze_direction = "RIGHT"
		else:
			gaze_direction = ""
		with open('gaze_log.txt', 'w') as f:
			f.write(gaze_direction)
